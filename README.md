...
当前版本：v1.1.0。Pro 的爆款分析已采用诊断式框架：图文使用 VISUAL-D、TRIGGER 与三层归因；视频使用时间轴、信息密度、信任建立与转化设计四维拆解。详见 [RELEASE_NOTES_v1.1.0.md](RELEASE_NOTES_v1.1.0.md)。

本仓库现在包含两个对外交付版本：

- Pro：`skills/xhs-viral-breakdown-to-bitable`，图文 + 视频统一入口，包含爆款拆解、视频字幕、Excel 备份、去重和飞书归档。
